...
public class GsonHelper {
	...
	public Object getJSONObject(String url, String encType, Map<String, String> header, Class<?> clazz) throws Exception{
		...
		if(is ==null) {
			throw new Exception("통신 처리실패했습니다.");
		}
		
		return this .getJSONObject(is, encType, clazz);
	}
	
	public Object getJONObject(String url, Map<String, String> header, Class<?> clazz)throws Exception{
		return this.getJSONObject(url, "urf-8", header, clazz);
	}
