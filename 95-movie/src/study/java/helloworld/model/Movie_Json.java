...
public class Movie_Json {
	...
	public String toString() {
		return "Movie_mdifiy [boxOfficeResult=" + boxOfficeResult + "]";
	}
	...
	public class BoxOfficeResult{
		...
		@Override
		public String toString() {
			return "BoxOfficeResult [boxofficeType=" + boxofficeType + ", showRange=" + showRange
		...
		public class DailyBoxOfficeList{
			...
			@Override
			public String toString() {
				return "DailyBoxOfficeList [rnum=" + rnum + ", rank=" + rank + ", rankInten=" + rankInten
						+ ", rankOldAndNew=" + rankOldAndNew + ", movieCd=" + movieCd + ", movieNm=" + movieNm
						+ ", openDt=" + openDt + ", salesAmt=" + salesAmt + ", salesShare=" + salesShare
						+ ", salesInten=" + salesInten + ", salesChange=" + salesChange + ", salesAcc=" + salesAcc
						+ ", audiCnt=" + audiCnt + ", audiInten=" + audiInten + ", audiChange=" + audiChange
						+ ", audiAcc=" + audiAcc + ", scrnCnt=" + scrnCnt + ", showCnt=" + showCnt + "]";
			}			
		}
	}		
}
